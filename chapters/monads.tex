...
\begin{proof}[Sketch of proof]
  ...
  Suppose \(\cat{C}^{T}\) is monoidal
  such that the forgetful functor \(U^T\) is strict monoidal.
...
\begin{remark}\label{rmk:graphical-comodule-functors}
  ...
  The coassociativity and counitality of \(G_{\mathsf{a}}\) is displayed in \cref{fig:coassoc-and-counital-comodule-functor};
...
to be morphisms of comodule functors is given in \cref{fig:comodule-monad}.
...
\begin{example}\label{ex:oplax-module-monad}
  ...
  Alternatively, it is monoid in the category
...
\begin{proof}
  ...
  \[
    ...
    \xrightarrow{\varepsilon_{Fx \otimes Fx}} Fx \otimes Fy,
  \]
  \[
...
\begin{proof}
  ...
  verifies the necessary the coherence conditions,
...
\begin{proof}
  ...
  and the two constructions are inverse of each other.
\end{proof}
...
\begin{proposition}\label{strongcomparisons}
  ...
  \begin{itemize}
    ...
    a lax \(\cat{C}\)\hyp{}module adjunctions
